-- [[
--  File: utils.lua
--  Summary: This file contains utility functions that are used throughout the addon. I also use it as a dumping ground for functions that I don't know where else to put. Probably will need to refactor this later.
-- ]]
